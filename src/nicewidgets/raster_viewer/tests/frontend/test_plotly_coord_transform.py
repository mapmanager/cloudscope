...
from raster_viewer.frontend.plotly_coord_transform import PlotlyCoordTransform, merge_partial_relayout
...
def test_plot_xy_round_trip() -> None:
    ...
    y_top, y_bot = t.row_col_to_plot_y_range_layout(b0)
    b1 = t.plot_xy_ranges_to_row_col(x_lo, x_hi, y_top, y_bot)
