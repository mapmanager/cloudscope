...
DEFAULT_TEXT_SIZE = 'text-xs'
DEFAULT_TABLE_FONT_SIZE_PX = 11
...
HOME_RIGHT_POOL_CLOSED_SPLITTER_PCT = 100.0
HOME_RIGHT_POOL_COLLAPSED_SLACK_PCT = 2.0
HOME_RIGHT_POOL_MAIN_MIN_SPLITTER_PCT = 25.0
...
_HOME_SPLITTER_KEYS = {
    ...
    'analysis_sum_intensity': 'home_analysis_sum_intensity_splitter_pct',
...
class AppConfigData:
    ...
    home_analysis_sum_intensity_splitter_pct: float = DEFAULT_HOME_ANALYSIS_SUM_INTENSITY_SPLITTER_PCT
    ...
    def from_json_dict(cls, payload: dict[str, object]) -> AppConfigData:
        ...
        return cls(
            ...
            home_analysis_sum_intensity_splitter_pct=_float_field(
                'home_analysis_sum_intensity_splitter_pct',
