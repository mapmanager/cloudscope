...
ACQ_FILE_LIST_SCHEMA = SchemaDefinition(
    ...
    fields=(
        ...
        FieldSchema(
            ...
            display_name='Loaded',
            value_type=ValueType.STR,
            description='Check mark when primary pixels and analysis CSV tables are loaded.',
            default_value='',
            group='File',
        ),
        FieldSchema(
            ...
            value_type=ValueType.STR,
            description='Check mark when the source loader exposes a reference image.',
            default_value='',
            group='Image',
        ),
        FieldSchema(
            ...
            value_type=ValueType.STR,
            description='Finder-style file size string read from the filesystem.',
            default_value='',
            group='File',
        ),
        FieldSchema(
