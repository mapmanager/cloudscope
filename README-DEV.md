...
acqstore
    ...
    zip -r cloudscope_src_20260529_v2.zip src -i '*.py' '*.md'
    zip -r cloudscope_tests_20260529_v2.zip tests -i '*.py' '*.md'
    zip -r cloudscope_docs_20260529_v2.zip docs -i '*.py' '*.md'
