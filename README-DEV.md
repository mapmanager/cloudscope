...
acqstore
    ...
    zip -r cloudscope_src_20260524_v4.zip src -i '*.py' '*.md'
    zip -r cloudscope_tests_20260524_v4.zip tests -i '*.py' '*.md'
    zip -r cloudscope_sandbox_20260524_v4.zip sandbox -i '*.py' '*.md'
    zip -r cloudscope_scripts_20260524_v4.zip scripts -i '*.py' '*.md'
